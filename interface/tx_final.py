...
class App(tk.Tk):
    ...
    def run_sim_alex(self):
        ...
        print(padder["pad2        ::p_out "].info())
        print(mdm["modulate:: X_N1"].info())
        # Chaîne TX
        ...
        padder["pad2        ::r_in "] = pad_src["generate    ::U_K "]
        padder["pad2        ::p_in "] = enc["encode     ::X_N "]
        padder["pad2        ::p_out "] = mdm["modulate:: X_N1"]
